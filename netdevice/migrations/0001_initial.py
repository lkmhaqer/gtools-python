    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interface', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='netdevice.interface')),
            ],
        ),
        migrations.CreateModel(
            name='network_os',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('local_aut_num', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bgp.aut_num')),
                ('network_os', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='netdevice.network_os')),
            ],
        ),
        migrations.AddField(
            model_name='ipv6_address',
            name='interface',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='netdevice.logical_interface'),
        ),
        migrations.AddField(
